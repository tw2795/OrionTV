...
describe("DeviceUtils", () => {
  ...
  describe("getDeviceType", () => {
    it("应该在宽度 >= 1024 时返回 tv", () => {
      mockedDimensions.get.mockReturnValue({ width: 1024, height: 768 , scale: 1, fontScale: 1});
      expect(DeviceUtils.getDeviceType()).toBe("tv");
    });

    it("应该在宽度 >= 768 且 < 1024 时返回 tablet", () => {
      mockedDimensions.get.mockReturnValue({ width: 768, height: 1024 , scale: 1, fontScale: 1});
      expect(DeviceUtils.getDeviceType()).toBe("tablet");
    });

    it("应该在宽度 < 768 时返回 mobile", () => {
      mockedDimensions.get.mockReturnValue({ width: 375, height: 812 , scale: 1, fontScale: 1});
  ...
  describe("isTV", () => {
    it("应该在 TV 设备上返回 true", () => {
      mockedDimensions.get.mockReturnValue({ width: 1920, height: 1080 , scale: 1, fontScale: 1});
  ...
  describe("isLandscape", () => {
    it("应该在横屏模式下返回 true", () => {
      mockedDimensions.get.mockReturnValue({ width: 812, height: 375 , scale: 1, fontScale: 1});
    ...
    it("应该在宽高相等时返回 false", () => {
      mockedDimensions.get.mockReturnValue({ width: 500, height: 500 , scale: 1, fontScale: 1});
      expect(DeviceUtils.isLandscape()).toBe(false);
    });
  });
